def game2():
    global myHero, myEvil_Duck
    carnival.start_countdown_game(60, carnival.WinTypes.WIN)
    ...
    myHero = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    controller.move_sprite(myHero)
    myHero.set_stay_in_screen(True)
    ...
    myEvil_Duck.set_position(148, 2)

def on_on_overlap(sprite, otherSprite):
    game.over(False)
sprites.on_overlap(SpriteKind.player, SpriteKind.enemy, on_on_overlap)

myEvil_Duck: Sprite = None
myHero: Sprite = None
game2()
