def game2():
    global myHero, myEvil_Duck, Evil_Duck2
    ...
    myHero = sprites.create(img("""
            . . . . . . . . . . . . . . . . 
                    ...
                    . . f 9 9 7 7 7 7 7 7 9 f f . . 
                    . f f 9 7 f f f f f f 7 9 f f . 
                    . f f f f f 9 9 9 9 f f f f f . 
                    . . f 9 f b f 4 4 f b f 9 f . . 
                    . . f 9 4 1 f d d f 1 4 9 f . . 
                    . . e f 9 4 d d d d 4 9 f . . . 
    ...
    Evil_Duck2 = sprites.create(img("""
        ...
        """),
        SpriteKind.enemy)
    myEvil_Duck.follow(myHero, 100, 100)
    myEvil_Duck.set_position(148, 2)
    Evil_Duck2.set_position(148, 2)
def game1():
